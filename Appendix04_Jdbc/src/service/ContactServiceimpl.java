...
public class ContactServiceimpl implements ContactService {
	...
	public void addContact() {
		...
		System.out.println(addResult + "개의 연락처가 저장되었습니다.");
	...
	public void removeContact() {
		...
		System.out.print(removeResult + "개의 연락처가 삭제되었습니다.");
	...
	public void modifyContact() {
		...
		default:
			...
			return; //모디파이 메소드 자체를 종료시킨다.(잘못된 입력이기 때문에 수정될일이 없도록)
